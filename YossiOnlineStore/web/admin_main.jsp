...
+" WHERE  `product_qty` <2 ";
                    ...
                    %>
                <h1 class="grid_15">לוח ראשי</h1><hr/>
                <a href="admin_manageProduct.jsp" id="buy"  class="grid_3"><%= qty %> מוצרים מתחת לכמות המינימלית</a>     
                <a href="admin_approvedOrders.jsp" id="buy"  class="grid_3"><%= approvedOrders %> מוצרים למשלוח</a>    
                <a href="admin_pendingOrders.jsp" id="buy" class="grid_3"><%= pendingOrders %> מוצרים לאישור</a>    
