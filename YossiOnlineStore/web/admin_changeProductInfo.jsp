            ...
            <% String tags = request.getParameter("tags");
                ...
                if (session.getAttribute("productId") != null && session.getAttribute("productName") != null) {
                    ...
                    if (request.getParameter("del") != null) {
                        ...
                        String sqlUpdateExpenses = "INSERT INTO  `shop_db`.`expenses` ("
+"  `expenses_id` , "
 +"   `product_id` ,"
 +"   `product_name` , "
  +"  `price` , "
 ...
 +"   NULL ,  '"+pid+"',  '"+productName+"',  '"+expenses+"', NOW( ) )";
            ...
            <div class="grid_16" style="padding: 10px;" id="whiteBox">
                ...
                <br/>
                <h1 class="grid_15" style="text-align: center;">המידע על המוצר עודכן</h1><hr/>

                <div class="grid_13 push_3">
                    <div class="grid_5">
                        <a href="admin_manageProduct.jsp" id="buy">נהל מוצרים</a>
                    </div>
                </div>
            </div>
            <%
            ...
            <div class="grid_16" style="padding: 10px;" id="whiteBox">
                        ...
                        if (totalQuantity <= 0  || productPrice <= 0){
                            %>
                                        ...
                                        <div class="grid_13 push_1">
                                            <div class="grid_7">
                                                <a href="admin_manageProduct.jsp?pid=<%= session.getAttribute("productId")%>" id="buy">בטל עידכון</a>
                                            </div>
                                        </div>
                ...
                <%
                        ...
                        <input type="hidden" name="del" value="y"/>
                                        ...
                                        <br/>
                                        <h1 class="grid_15" style="text-align: center;">האם אתה בטוח שברצונך לעדכן את המוצר?<br/><br/><span class="blue"></span> <%= session.getAttribute("productName")%></h1><hr/>

                                        <div class="grid_13 push_1">
                                            <div class="grid_5">
                                                <input type="submit" id="buy" style="border-color: #FFF; width: 190px;" value="עדכן מוצר"/>
                                            </div>
                                            <div class="grid_6">
                                                <a href="admin_manageProduct.jsp?pid=<%= session.getAttribute("productId")%>" id="buy">לא, בטל עידכון</a>
                                            </div>
                                        </div>
                                </form>
                                        <div class="clear"></div>
