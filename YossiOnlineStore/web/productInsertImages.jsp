                ...
                <div style="padding: 10px;" class="grid_13">
                    <h3  align="center">
                        <%
                            if ((session.getAttribute("productName") == null)) {
                                out.println("לא זוהה מוצר לתמונה זו");
                            }else {
                        %>
                    </h3>        
                    <h1><% out.print("דף העלאת תמונות<br/>" + session.getAttribute("productName"));%></h1>
                    <p>
                        <%
                    ...
                    <form method="post" action="uploadImage.jsp" name="upform" enctype="multipart/form-data">
                        ...
                        <table width="60%" border="0" cellspacing="1" cellpadding="1" align="center" class="style1">
                            <tr>
                                <td align="left"><b>בחר תמונה להעלאה</b></td>
                            </tr>
                            <tr>
                                <td align="left">
                        ...
                        %>
                        <a href="admin_manageProduct.jsp?pid=<%= (String)session.getAttribute("productId") %>" style="float: left;" id="buy" >ערוך מוצר</a>
                        ...
                        <%
                            ...
                            if (result.equals("הקובץ עלה")) {
                        %>

                        File <%= request.getAttribute("fileName")%> uploaded to <%= path%>
