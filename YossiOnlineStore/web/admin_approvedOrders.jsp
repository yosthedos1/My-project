    ...
    <body>
        ...
        <div class="container_16">
            ...
            <div class="grid_16" style="padding: 10px;" id="whiteBox">
                ...
                <br/>
                <h1 class="grid_15">מוצרים שאושרו</h1><hr/>
            ...
            <form method="post" action="changeProductStatus">
                <div class="grid_16">
                    <div class="grid_16"  id="CartTable" style="padding:10px 00px;">
                        <h1 class="grid_15" style ="text-align: center; padding: 10px 0px 10px 0px;  border-top: 20px #444 solid;">מוצרים שאושרו</h1>  
                        
                        <div class="clear"></div>
                        <div class="grid_10">
                        <input id="greenBtn" type="submit" value="שנה סטטוס מוצר">
                        <select name="ChangeStatus">
                            <option value="delivered">מאושר למשלוח</option>
                            <option value="cancel">ביטול</option>
                        </select></div>
                        <div class="clear"></div>
                        <%-----------------%>
                        <div class="grid_1">
