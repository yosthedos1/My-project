    ...
    $(document).ready (function (){
        ...
        tags.keyup(function (){
         ...
         <div class="grid_13"  style="padding: 10px 0px;" id="whiteBox">
                ...
                <div class="grid_13">
                    <br/><h1>שלב שלישי - הכנס שם מוצר ותגיות</h1><hr/>
                </div>
                ...
                <form method="post" action="admin_addProduct_controller.jsp">
                    ...
                    <div class="grid_5">
                        <input id="productName" type="text" name= "productName"  placeholder="שם המוצר" required/><br/>
                    ...
                    <div class="grid_5">
                        <textarea id="tags" name= "tags" placeholder="הכנס תגיות ללא פסיקים" required></textarea>
                    </div>
                    
                    <div class="clear"></div><br/>
                    <div class="grid_7">
                        <input id="buy" class="next" type="submit" value="הבא"/>
                    </div>
                </form>
