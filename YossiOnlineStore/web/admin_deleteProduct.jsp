 ...
 * 
         ...
         %>
                    <div class="grid_16" style="padding: 10px;" id="whiteBox">
                        ...
                        <br/>
                        <h1 class="grid_15" style="text-align: center;">המוצר נמחק</h1><hr/>

                                <div class="grid_13 push_3">
                                    <div class="grid_5">
                                        <a href="admin_manageProduct.jsp" id="buy">ניהול מוצרים</a>
                                    </div>
                                </div>
                    </div>
                    <%
                    ...
                    <div class="grid_16" style="padding: 10px;" id="whiteBox">
                        ...
                        <br/>
                        <h1 class="grid_15" style="text-align: center;">האם אתה בטוח שברצונך למחוק מוצר זה<br/><br/><span class="blue">Product Name</span> : <%= session.getAttribute("productName")%><br/> ואת כל התמונות המצורפות לו?</h1><hr/>

                        <div class="grid_13 push_1">
                            <div class="grid_5">
                                <a href="admin_deleteProduct.jsp?pid=<%= session.getAttribute("productId")  %>&del=y" id="buy">כן, מחק אותו</a>
                            </div>
                            <div class="grid_5">
                                <a href="admin_manageProduct.jsp?pid=<%= session.getAttribute("productId")  %>" id="buy">לא, אל תמחק</a>
                            </div>
                        </div>
                    </div>
                    <%
