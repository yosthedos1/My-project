...
<body>
    ...
    <div class="container_16">
        ...
        <div class="grid_16" style="padding: 10px;" id="whiteBox">
            ...
            <br/>
            <h1 class="grid_15" style="text-align: center;">נא לבחור תמונה למחיקה</h1><hr/>

            <div class="grid_13 push_3">
                <div class="grid_5">
                    <a href="admin_manageProduct.jsp" id="buy">ערוך מוצרים</a>
                </div>
            </div>
        </div>
        <%    } else {
                    ...
                    */
                    ...
                    Statement st = c.createStatement();
                            ...
                            <div class="grid_16" style="padding: 10px;" id="whiteBox">
                                ...
                                <br/>
                                <h1 class="grid_15" style="text-align: center;">תמונת המוצר נמחקה</h1><hr/>

                                <div class="grid_13 push_3">
                                    <div class="grid_5">
                                        <a href="admin_manageProduct.jsp?pid=<%=session.getAttribute("productId")%>" id="buy">ערוך מוצרים</a>
                                    </div>
                                </div>
                            </div>
                            <%
