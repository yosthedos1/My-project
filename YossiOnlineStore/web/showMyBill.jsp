            ...
            <div class="grid_12 push_2" id="whiteBox">
                ...
                <div class="grid_4" >
                    <div id="status" class="grid_3">
                        ...
                        {
                            %>
                    <a target="_blank" id="status" class="grid_3" href="showMyBill_Print.jsp?oid=<%= OrderId %>">הדפס את החשבון</a>
                    <%
   ...
   %>
            <div id="whiteBox" class="grid_12 push_2">
                ...
                <%
                      ...
                      <div class="container_16">
                          <div class="grid_12 push_2" id="whiteBox">
                              <br/><h1>אין מוצרים להצגה</h1><hr/><br/>
                          </div>
                      </div>
        <%
                      }                       
