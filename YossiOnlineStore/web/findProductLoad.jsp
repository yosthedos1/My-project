...
product-name	product_id	sub-category-name	category-name	company-name	price	summary	image-id	image-name*/
                        ...
                        <div class="grid_14">
                            ...
                            <div class="grid_3">
                                <p><%=sub_category_name %> <br/> <a href="admin_manageProduct.jsp?pid=<%= product_id %>" id="greenBtn">עריכה</a><a style="margin-right: 10px;" href="addToCart.jsp?id=<%= product_id %>" id="greenBtn">הוסף לעגלה</a><p></p>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <%
